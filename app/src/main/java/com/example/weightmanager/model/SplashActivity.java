...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cursor.getCount() == 0)
        {
            ...
            sqlDB.execSQL("INSERT INTO Board (goal, title, text, image) VALUES (0,'체중증가가 안되는 이유' ,'보통 식습관이 원인인 경우가 대부분이기 때문에 평소에 편식하는 습관을 갖는다거나 섭취하는 음식량이 적은 경우에는 올바른 식습관을 갖는 것이 좋은데요.\n\n" +
